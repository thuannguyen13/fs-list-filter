...
> = {
  text: {
    single: {
      [OP_CONTAIN]: [TEXT, SEARCH],
      [OP_NOT_CONTAIN]: [TEXT, SEARCH],
      [OP_START]: [TEXT, SEARCH],
      [OP_NOT_START]: [TEXT, SEARCH],
      [OP_END]: [TEXT, SEARCH],
      [OP_NOT_END]: [TEXT, SEARCH],
      [OP_EQUAL]: [SELECT_MULTIPLE, SELECT_ONE, TEXT, CHECKBOX, RADIO],
      [OP_NOT_EQUAL]: [SELECT_MULTIPLE, SELECT_ONE, TEXT, CHECKBOX, RADIO],
      [OP_EMPTY]: [],
      [OP_NOT_EMPTY]: [],
    },
    multiple: {
  ...
  number: {
    single: {
      [OP_EQUAL]: [NUMBER, TEXT, RADIO],
      [OP_NOT_EQUAL]: [NUMBER, TEXT, RADIO],
      [OP_LESS]: [NUMBER, TEXT, RANGE],
      [OP_LESS_EQUAL]: [NUMBER, TEXT, RANGE],
      [OP_GREATER]: [NUMBER, TEXT, RANGE],
      [OP_GREATER_EQUAL]: [NUMBER, TEXT, RANGE],
      [OP_EMPTY]: [],
      [OP_NOT_EMPTY]: [],
    },
    multiple: {
